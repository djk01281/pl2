...
{
  "$end", "error", "$undefined", "IDENTIFIER", "CONSTANT", "INT", "';'",
  "'='", "$accept", "primary_expression", "declaration", "$@1", "$@2",
  "init_declarator", "$@3", "$@4", "translation_unit", YY_NULLPTR
};
#endif
