...
static const char *const yytname[] =
{
  ...
  "'='", "$accept", "primary_expression", "expression", "declaration",
  "$@1", "$@2", "init_declarator", "translation_unit", YY_NULLPTR
};
#endif
